...
public class OperatorManager
{
    ...
    public Task<List<StopDto>> GetAllStopsAsync(int? countryId = null, CancellationToken ct = default)
        => _transit.GetStopsAsync(countryId, ct);

    public Task<List<RouteDto>> GetAllRoutesAsync(int? countryId = null, CancellationToken ct = default)
        => _transit.GetRoutesAsync(countryId, ct);
