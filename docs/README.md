...
- [guides/running-locally.md](guides/running-locally.md) — **the single command reference:** every command to build, run (OTP, both APIs, the MAUI app), migrate the databases, and test the stack
