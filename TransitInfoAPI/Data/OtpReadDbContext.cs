...
public sealed class OtpReadDbContext : DbContext
{
    ...
    public DbSet<MobilityProviderReadModel> MobilityProviders => Set<MobilityProviderReadModel>();

    public override int SaveChanges()
        => throw new NotSupportedException("TransitInfoAPI database context is read-only.");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MobilityProviderReadModel>(entity =>
        {
            entity.ToTable("MobilityProviders");
            entity.HasKey(x => x.Id);
            entity.Property(x => x.Name).IsRequired();
            entity.Property(x => x.ApiBaseUrl).IsRequired();
        });
    }
}
...
public sealed class MobilityProviderReadModel
{
    public int Id { get; set; }
    public string Name { get; set; } = string.Empty;
