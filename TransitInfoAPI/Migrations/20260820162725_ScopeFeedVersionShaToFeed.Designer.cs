...
namespace TransitInfoAPI.Migrations
{
    ...
    [Migration("20260820162725_ScopeFeedVersionShaToFeed")]
    partial class ScopeFeedVersionShaToFeed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.CanonicalRoute", b =>
                {
                    ...
                    b.Property<int?>("LastSeenFeedVersionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.CustomSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateOnly?>("ServiceWindowEnd")
                        .HasColumnType("date");

                    b.Property<DateOnly?>("ServiceWindowStart")
                        .HasColumnType("date");
                    ...
                    b.ToTable("CustomSources");
                });

            modelBuilder.Entity("TransitInfoAPI.Entities.CustomSourceMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CustomSourceRequestId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CustomSourceRequestId", "SortOrder");

                    b.ToTable("CustomSourceMappings");
                });

            modelBuilder.Entity("TransitInfoAPI.Entities.CustomSourceRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CustomSourceId", "SortOrder");

                    b.ToTable("CustomSourceRequests");
                });

            modelBuilder.Entity("TransitInfoAPI.Entities.CustomSourceRun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CustomSourceId", "StartedAt");

                    b.ToTable("CustomSourceRuns");
                });
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.FeedVersion", b =>
                {
                    ...
                    b.Property<string>("SynthesizedSections")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.Operator", b =>
                {
                    ...
                    b.Property<double?>("RegionCentroidLat")
                        .HasColumnType("float");

                    b.Property<double?>("RegionCentroidLon")
                        .HasColumnType("float");

                    b.Property<string>("RegionName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double?>("RegionRadiusKm")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.ReconciliationCandidate", b =>
                {
                    ...
                    b.Property<decimal?>("AutoMergeDistanceMetersAtDecision")
                        .HasPrecision(14, 4)
                        .HasColumnType("decimal(14,4)");

                    b.Property<decimal?>("AutoMergeNameThresholdAtDecision")
                        .HasPrecision(5, 4)
                    ...
                    b.Property<decimal?>("ManualReviewDistanceMetersAtDecision")
                        .HasPrecision(14, 4)
                        .HasColumnType("decimal(14,4)");

                    b.Property<decimal?>("ManualReviewNameThresholdAtDecision")
                        .HasPrecision(5, 4)
                        .HasColumnType("decimal(5,4)");
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.StationMergeLog", b =>
                {
                    ...
                    b.Property<string>("MovedRawStopIds")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.StopGazetteerEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Region", "NormalizedName");

                    b.ToTable("StopGazetteerEntries");
                });

            modelBuilder.Entity("TransitInfoAPI.Entities.StopLocationCacheEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NormalizedName", "OperatorId")
                        .IsUnique();

                    b.ToTable("StopLocationCacheEntries");
                });
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.StopTime", b =>
                {
                    ...
                    b.HasIndex("CanonicalStationId", "DepartureTime");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("CanonicalStationId", "DepartureTime"), new[] { "TripId" });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TransitInfoAPI.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.AuditLog", b =>
                {
                    b.HasOne("TransitInfoAPI.Entities.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.CustomSourceMapping", b =>
                {
                    b.HasOne("TransitInfoAPI.Entities.CustomSourceRequest", "CustomSourceRequest")
                        .WithMany("Mappings")
                        .HasForeignKey("CustomSourceRequestId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("CustomSourceRequest");
                });

            modelBuilder.Entity("TransitInfoAPI.Entities.CustomSourceRequest", b =>
                {
                    b.HasOne("TransitInfoAPI.Entities.CustomSource", "CustomSource")
                        .WithMany("Requests")
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.StationMergeLog", b =>
                {
                    b.HasOne("TransitInfoAPI.Entities.CanonicalStation", "Source")
                        .WithMany()
                        .HasForeignKey("SourceStationId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("TransitInfoAPI.Entities.CanonicalStation", "Target")
                        .WithMany()
