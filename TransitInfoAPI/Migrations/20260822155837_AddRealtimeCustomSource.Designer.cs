...
namespace TransitInfoAPI.Migrations
{
    ...
    [Migration("20260822155837_AddRealtimeCustomSource")]
    partial class AddRealtimeCustomSource
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.Alert", b =>
                {
                    ...
                    b.Property<string>("MatchedRouteIds")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.AlertSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CategorySelector")
                        .HasMaxLength(400)
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.CustomSource", b =>
                {
                    ...
                    b.Property<bool>("ProducesMobility")
                        .HasColumnType("bit");

                    b.Property<bool>("ProducesRealtime")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TransitInfoAPI.Entities.Feed", b =>
                {
                    b.HasOne("TransitInfoAPI.Entities.AlertSource", "AlertSource")
                        .WithMany("Feeds")
